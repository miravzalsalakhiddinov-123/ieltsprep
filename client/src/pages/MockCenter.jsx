      ...
      {mocks.map(mock => (
        <div className="card" key={mock.id} style={{ marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 12.5, color: 'var(--text-muted)', marginTop: 6, marginBottom: 14 }}>
            ...
            You can also open a single section below to practice it on its own — but each section can only be taken once, so make sure you're ready before you start.
          </p>
              ...
              return (
                ...
                >
                  ...
                  {pending
                    ...
                    : attempt ? <span className="badge reviewed">✓ Completed</span> : <span className="btn">Start</span>}
                </div>
              );
            })}
