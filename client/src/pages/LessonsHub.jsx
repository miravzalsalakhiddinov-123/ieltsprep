    ...
    <div>
      ...
      <div className="hub-grid">
        <div className="hub-card" style={{ '--card-accent': 'var(--accent)' }} onClick={() => navigate('/lessons/samples')}>
          ...
          <div className="hub-card-sub">Model answers — question, prompt materials, and a full sample answer</div>
        ...
        <div className="hub-card" style={{ '--card-accent': 'var(--accent-2)' }} onClick={() => navigate('/lessons/mini-lessons')}>
          ...
          <div className="hub-card-sub">Short articles on strategy, grammar, and technique</div>
